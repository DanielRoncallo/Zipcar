...
<title>ZipCar - Proyecto Diseño de Software Uninorte</title>
<!--Bootstrap -->
...
<section class="contact_us section-padding">
  <div class="container">
    <div  class="row">
      <div class="col-md-6">
        <h3>Contactenos Llenando los campos con sus datos: </h3>
        ...
        <div class="contact_form gray-bg">
          <form  method="post">
            ...
            <div class="form-group">
              <label class="control-label">Numero de Telefono <span>*</span></label>
            ...
            <div class="form-group">
              <button class="btn" type="submit" name="send" type="submit">Enviar Message <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
