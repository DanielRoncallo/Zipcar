...
<head>
	...
	<title>ZipCar Portal | Admin Crear Marca</title>
	...
	<?php include('includes/leftbar.php');?>
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Manejar Paginas </h2>
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Seleccione Pagina</label>
												<div class="col-sm-8">
                  ...
                  <option value="manage-pages.php?type=privacy">Derechos Reservados</option>
                  ...
                  <option value="manage-pages.php?type=faqs">FAQs</option>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Pagina Seleccionada</label>
												<div class="col-sm-8">
						<?php
			...
			?>
									...
									<div class="form-group">
												<label class="col-sm-4 control-label">Detalles De La Pagina </label>
												<div class="col-sm-8">
