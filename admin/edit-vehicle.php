			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Editar Vehiculo</h2>
...
<?php if($msg){?><div class="succWrap"><strong>PROCESO COMPLETADO</strong>:<?php echo htmlentities($msg); ?> </div><?php } ?>
<?php 
$id=intval($_GET['id']);
...
<label class="col-sm-2 control-label">Vehiculo<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label">Detalles Vehiculo<span style="color:red">*</span></label>
<div class="col-sm-10">
...
<div class="form-group">
<label class="col-sm-2 control-label">Precio por dia(en USD)<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<label class="col-sm-2 control-label">Capacidad de Asientos<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<label for="inlineCheckbox2"> Seguro Electrico </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-success checkbox-inline">
<input type="checkbox" id="inlineCheckbox1" name="powerdoorlocks" value="1">
<label for="inlineCheckbox2"> Seguridad de Puertas </label>
</div>
<?php }?>
</div>
<div class="col-sm-3">
...
<label for="inlineCheckbox3"> Seguridad Anti Robos </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Freno Asistido </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox1"> Volante Asistido </label>
</div>
<?php } else {?>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2">Bolsa de aire Pasajero</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3">Bolsa de aire Pasajero</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Ventanas Electricas </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox1"> Radio </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2">Cerrado Central</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-success checkbox-inline">
...
<label for="inlineCheckbox3"> Sensor de Colision </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
