...
<div class="form-group">
<label class="col-sm-2 control-label">Descripcion del Vehiculo<span style="color:red">*</span></label>
<div class="col-sm-10">
...
<div class="form-group">
<label class="col-sm-2 control-label">Precio Por Dia(en COP)<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="col-md-12">
<div class="panel panel-default">
<div class="panel-heading">Acesorios</div>
<div class="panel-body">
...
<label for="powerdoorlocks"> Puertas con Seguro Electrico </label>
</div></div>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
<input type="checkbox" id="antilockbrakingsys" name="antilockbrakingsys" value="1">
<label for="antilockbrakingsys"> Anti Robo </label>
</div></div>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="brakeassist" name="brakeassist" value="1">
<label for="brakeassist"> Freno Asistido </label>
</div>
</div>
