...
<div class="modal fade" id="forgotpassword">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3 class="modal-title">Recuperacion de Contraseña</h3>
      </div>
  ...
  <div class="form-group">
              ...
              <div class="text-center">
                <p class="gray_text">Por motivos de seguridad no guardamos su clave, recibira una provisional en el correo.</p>
                <p><a href="#loginform" data-toggle="modal" data-dismiss="modal"><i class="fa fa-angle-double-left" aria-hidden="true"></i> Devuelta al Login</a></p>
              </div>
            </div>
          </div>
        </div>
