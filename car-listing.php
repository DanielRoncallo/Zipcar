...
<title>ZipCar | Listado de Carros</title>
<!--Bootstrap -->
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-filter" aria-hidden="true"></i> Encuentra tu Carro </h5>
          </div>
...
<?php }} ?>
              ...
              <div class="form-group select">
                <select class="form-control" name="fueltype">
                  <option>Seleccionar tipo de combustible</option>
...
<option value="CNG">Gas</option>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-car" aria-hidden="true"></i> Carros Listados Recientemente</h5>
          </div>
