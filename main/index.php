      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Encuentra El Carro Indicado!</h1>
            <p>Tenemos cientos de carros Listos para escoger. </p>
            <a href="#" class="btn">Leer Mas <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a> </div>
        </div>
      </div>
    </div>
  </div>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Encuentra El Mejor <span>Carro Para Ti</span></h2>
      <p>Lorem Ipsum.</p>
    </div>
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">Nuevo</a></li>
        </ul>
      </div>
